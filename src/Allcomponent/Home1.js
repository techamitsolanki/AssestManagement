          ...
          <div className="row">
            <div id="rev_slider_4_1_wrapper" className="rev_slider_wrapper fullwidthbanner-container" data-alias="classNameicslider1" style={{ margin: "0px auto", backgroundColor: "transparent", padding: "0px", marginTop: "0px", marginBottom: "0px" }}>
              ...
              <div id="rev_slider_4_1" className="rev_slider fullwidthabanner" style={{ display: "none" }} data-version="5.0.7">
                <ul>
                  <li className='' data-index="rs-1812" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/it_service/slide1.jpg" data-rotate="0" data-saveperformance="off" data-title="Computer Services" data-description="">
                    {/*   MAIN IMAGE  */}
                    ...
                    <div className="tp-caption tp-shape tp-shapewrapper   tp-resizeme rs-parallaxlevel-0"
                      ...
                      data-responsive_offset="on"
                      style={{ zIndex: "5", backgroundColor: "rgba(0, 0, 0, 0.25)", borderColor: "rgba(0, 0, 0, 0.50)" }}></div>
                    {/* style={{zIndex: 5;background-color:rgba(29, 29, 29, 0.85);border-color:rgba(0, 0, 0, 0.50);"> </div> */}
                    {/*   LAYER NR. 2  */}
                  ...
                  <li data-index="rs-181" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/it_service/slide2.jpg" data-rotate="0" data-saveperformance="off" data-title="Easy To Use & Customize" data-description="">
                    ...
                    <div className="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                      ...
                      data-splitout="none"
                      data-responsive_offset="on"
                      style={{ zIndex: "6", whiteSpace: "nowrap" }}>Available On It.Next </div>
                  </li>
